...
it('creates valid audience demographic records with factory defaults and casts', function (): void {
    ...
    expect($demographic->socialAccount)->toBeInstanceOf(SocialAccount::class)
...
it('defines instagram account relationship', function (): void {
    ...
    expect($demographic->socialAccount())->toBeInstanceOf(BelongsTo::class)
        ->and($demographic->socialAccount)->toBeInstanceOf(SocialAccount::class);
});
