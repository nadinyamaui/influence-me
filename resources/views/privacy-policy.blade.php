            ...
            <div class="space-y-8 text-justify text-sm leading-7 text-slate-600 sm:text-base">
                ...
                <section class="space-y-3">
                    ...
                    <ul class="list-disc space-y-2 pl-6">
                        ...
                        <li><span class="font-medium text-slate-800">Financial and transaction data:</span> invoices, invoice line items, currency and pricing context, payment status and related transaction references.</li>
                ...
                <section class="space-y-3">
                    ...
                    <ul class="list-disc space-y-2 pl-6">
                        ...
                        <li>Information from integrations you authorize, including Instagram and TikTok.</li>
                ...
                <section class="space-y-3">
                    ...
                    <ul class="list-disc space-y-2 pl-6">
                        ...
                        <li>Track invoice payment outcomes and maintain required accounting records.</li>
                ...
                <section class="space-y-3">
                    ...
                    <ul class="list-disc space-y-2 pl-6">
                        ...
                        <li>Integration providers you authorize, such as Instagram and TikTok, each of which has independent privacy practices.</li>
