    ...
    <div class="mx-auto max-w-7xl px-6">
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('auth.facebook', ['driver' => 'instagram']) }}" class="inline-flex items-center gap-2 rounded-full bg-slate-900 px-4 py-2 text-xs font-medium text-white transition-all hover:bg-slate-800 hover:shadow-lg hover:shadow-slate-200 focus:ring-2 focus:ring-slate-400 focus:ring-offset-2">
