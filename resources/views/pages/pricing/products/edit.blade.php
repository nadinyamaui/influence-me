<div class="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-6">
    <div class="flex flex-wrap items-start justify-between gap-3">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-900 dark:text-zinc-100">Edit Pricing Product</h1>
            <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-300">Update platform, deliverable metadata, and pricing details.</p>
        </div>
    ...
    <form wire:submit="save" class="space-y-5 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <div class="grid gap-5 md:grid-cols-2">
            ...
            <flux:field>
                ...
                <flux:input wire:model="base_price" name="base_price" type="number" step="0.01" min="0" required />
