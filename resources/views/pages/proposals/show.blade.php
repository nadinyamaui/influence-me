        ...
        <div>
            ...
            <div class="mt-2 flex flex-wrap items-center gap-2 text-sm text-zinc-600 dark:text-zinc-300">
                ...
                @if ($proposal->client !== null)
                    <a
                        href="{{ route('clients.show', $proposal->client) }}"
                        wire:navigate
                        class="font-medium text-zinc-700 underline decoration-zinc-300 underline-offset-2 transition hover:text-zinc-900 hover:decoration-zinc-500 dark:text-zinc-200 dark:decoration-zinc-600 dark:hover:text-zinc-100 dark:hover:decoration-zinc-400"
                    >
