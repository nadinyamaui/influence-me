            ...
            <div class="mx-auto grid max-w-7xl gap-16 px-6 pb-20 pt-24 lg:grid-cols-12 lg:items-end">
                <div class="lg:col-span-7">
                    ...
                    <div class="mt-10 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
                        <a href="{{ route('social.auth', ['provider' => \App\Enums\SocialNetwork::Instagram]) }}" class="inline-flex w-full items-center justify-center gap-2 rounded-full border border-teal-200 bg-teal-300 px-7 py-3 text-sm font-semibold text-slate-950 transition hover:bg-teal-200 sm:w-auto">
            ...
            <div class="mx-auto max-w-7xl px-6">
                ...
                <div class="mx-auto grid max-w-6xl gap-6 lg:grid-cols-3">
                    <article class="stagger flex flex-col rounded-3xl border border-slate-300 bg-white p-7">
                        ...
                        <a href="{{ route('social.auth', ['provider' => \App\Enums\SocialNetwork::Instagram]) }}" class="mt-8 inline-flex items-center justify-center rounded-full border border-slate-300 px-4 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-100">Get Started</a>
                    </article>
                    ...
                    <article class="relative flex flex-col rounded-3xl border border-slate-900 bg-slate-900 p-7 text-white shadow-xl shadow-slate-400/30">
                        ...
                        <a href="{{ route('social.auth', ['provider' => \App\Enums\SocialNetwork::Instagram]) }}" class="mt-8 inline-flex items-center justify-center rounded-full bg-teal-300 px-4 py-2.5 text-sm font-semibold text-slate-950 transition hover:bg-teal-200">Start Free Trial</a>
                    </article>
        ...
        <section class="border-t border-slate-300 bg-slate-950 py-20">
            <div class="mx-auto grid max-w-7xl gap-8 px-6 lg:grid-cols-12 lg:items-center">
                <div class="lg:col-span-7">
                    ...
                    <a href="{{ route('social.auth', ['provider' => \App\Enums\SocialNetwork::Instagram]) }}" class="mt-10 inline-flex items-center justify-center gap-2 rounded-full bg-teal-300 px-8 py-3 text-sm font-semibold text-slate-950 transition hover:bg-teal-200">
                        <i class="fa-brands fa-instagram" aria-hidden="true"></i>
                        Continue with Instagram
                    </a>
                </div>
